...
steps are rollback/yank workflow automation, a signed-tag policy for stronger
tag identity, and promotion criteria for declaring releases production-stable.
