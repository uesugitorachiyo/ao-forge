...
and live branch-protection evidence for `main`. It is not yet broad multi-user
production infrastructure. The next hardening step is scheduled post-release
drift verification for promoted releases.
